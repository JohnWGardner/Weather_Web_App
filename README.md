...
- **NEW:** Fetch real-time weather data and a simple, easy-to-digest 5-day weather forecast.
...
- **NEW:** Implement error handling for invalid city inputs and show meaningful error messages.
...
- **NEW:** A weather search form using Bootstrap components, allowing users to input a city and retrieve weather data.
- **NEW:** A real-time display of current weather data, including temperature, condition, humidity, and wind speed.
- **NEW:** A 5-day weather forecast, using Bootstrap cards, showing daily conditions, temperatures, humidity, and wind speeds.
- **NEW:** Fetching data dynamically from the OpenWeatherMap API.
- **NEW:** Error handling with messages if the city is not found or if there’s an API issue.

## 2. Additional Features:

- **NEW:** Responsiveness ensured using Bootstrap 4.6, so the app works across various screen sizes.
...
- **NEW:** Users who want real-time weather data and a 5-day forecast for planning their daily or weekly activities.

## 2. User Stories

- **NEW:** As a user, I want to check the current weather in a specific city so that I can plan my day accordingly.
...
- **NEW:** As a user, I want to see a 5-day weather forecast to help plan my activities for the week.
...
- **NEW:** The OpenWeatherMap API is used to retrieve real-time weather and 5-day forecast data based on user input.
...
- **NEW:** Warm color scheme used for forecast cards to enhance visual appeal and indicate specific weather conditions (e.g., warning backgrounds).
